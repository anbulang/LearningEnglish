...
- `docs/architecture/*`
- `docs/harness/*`
- `docs/project/2026-06-11-status-and-todo.md`
...
- 最新项目级进度与 ToDo 统一以 `docs/project/2026-06-11-status-and-todo.md` 为准；旧快照不再并存。
